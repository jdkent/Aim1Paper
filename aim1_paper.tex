...
ROI-ROI pair correlation differences between conditions relative to chance, but LSS did not (see supplementary figures).
...
Since the beta estimates for each event within LSS are not orthogonal with respect to each other,
there is the possibility the subsequent correlations between beta series become related to each other.
The influence of adjacent events was not captured in the simulations making adjacent events from
different conditions a likely culprit.
