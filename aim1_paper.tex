...
Our simulations show LSS outperforms LSA, but participant data
does not show an advantage using LSS.
Overall, results show the importance of validation using both simulations
and participant data and impacts how future studies should design their tasks
...
We seek to validate and compare two methods that may measure brain responses to events that occur
close in time.
