...
Contrary to the simulations, there is some evidence of LSS 
...
detect differences between conditions, the real data does not support that claim.
...
suggesting the differences between blocks could be driven by something other than
