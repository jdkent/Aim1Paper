...
a significant correlation difference between task conditions.
However, if there was a systematic bias in the observed correlations, then precision of sample correlation
would be low, but the correlation difference between task conditions could still be high.
...
However, the simulations we performed differ from real data in several key areas: the contrasts between task conditions,
