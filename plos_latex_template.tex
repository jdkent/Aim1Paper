...
Such designs are called fast event related designs and are the most commonly
used task design with the fMRI approach in cognitive neuroscience \ref{fig:introhrf}.
...
during resting state, expected spurious results found
...
We simulated data using the task switching design and found comparable
...
Third, we thank Chris Oehler and Adriana-Rivera Dompencial collected the real data used in the data analysis.
