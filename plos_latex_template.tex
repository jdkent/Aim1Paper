...
the sluggish Blood Oxygen Level Dependent (BOLD) response \ref{fig:introhrf}.
...
peak and around 16 seconds to effectively resolve.
...
We derived CNRs of 1 and 2 as reasonable values from the dataset.
...
and arrived at Activation Variation Noise ratios (AVNR) of 1 and 2.
...
\begin{figure}[H]
  ...
  \subfloat{\includegraphics[width=\textwidth]{avnr-10_fpr}}
...
\begin{figure}[H]
  ...
  \subfloat{\includegraphics[width=\textwidth]{avnr-10_smalldiff}}
